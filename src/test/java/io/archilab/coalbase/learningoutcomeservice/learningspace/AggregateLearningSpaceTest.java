...
import io.archilab.coalbase.learningoutcomeservice.learningoutcome.LearningOutcomeRepository;
...
public class AggregateLearningSpaceTest {
  ...
  public void createLearningSpace() throws Exception {
    ...
    this.mvc.perform(post("/learningSpaces")
        ...
        .andExpect(
            jsonPath("$.examForm.type", is(
                AggregateLearningSpaceTest.createExamForm().getType().getType())))
        .andExpect(
            jsonPath("$.examForm.schedules[0].value",
                is(AggregateLearningSpaceTest.createExamForm().getSchedules().get(0).getValue())))
        .andExpect(
            jsonPath("$.examForm.scope.minValue", is(
                AggregateLearningSpaceTest.createExamForm().getScope().getMinValue())))
        .andExpect(
  ...
  public void getLearningSpaces() throws Exception {
    ...
    this.mvc.perform(get("/learningSpaces").with(csrf()))
        ...
        .andExpect(
            jsonPath("$._embedded.learningSpaces[0].examForm.type",
                is(AggregateLearningSpaceTest.createExamForm().getType().getType())))
        .andExpect(
            jsonPath("$._embedded.learningSpaces[0].examForm.schedules[0].value",
                is(AggregateLearningSpaceTest.createExamForm().getSchedules().get(0).getValue())))
        .andExpect(
            jsonPath("$._embedded.learningSpaces[0].examForm.scope.minValue",
                is(AggregateLearningSpaceTest.createExamForm().getScope().getMinValue())))
        .andExpect(
        ...
        .andExpect(
            jsonPath("$._embedded.learningSpaces[1].examForm.type",
                is(AggregateLearningSpaceTest.createExamForm().getType().getType())))
        .andExpect(
            jsonPath("$._embedded.learningSpaces[1].examForm.schedules[0].value",
                is(AggregateLearningSpaceTest.createExamForm().getSchedules().get(0).getValue())))
        .andExpect(
            jsonPath("$._embedded.learningSpaces[1].examForm.scope.minValue",
                is(AggregateLearningSpaceTest.createExamForm().getScope().getMinValue())))
        .andExpect(
  ...
  private LearningSpace buildSampleLearningSpaceWithRequirment() {
    ...
    LearningSpace firstLearningSpace = new LearningSpace("FirstLearningSpace",
        AggregateLearningSpaceTest.createExamForm(),
    ...
    Requirement secondRequirement = new Requirement("Alles können und noch mehr",
        TaxonomyLevel.EVALUATION);
    ...
    return new LearningSpace("LearningSpaceWithRequirement",
        AggregateLearningSpaceTest.createExamForm(),
