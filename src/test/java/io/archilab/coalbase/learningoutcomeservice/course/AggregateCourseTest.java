...
import io.archilab.coalbase.learningoutcomeservice.learningspace.ExamForm;
import io.archilab.coalbase.learningoutcomeservice.learningspace.LearningSpace;
import io.archilab.coalbase.learningoutcomeservice.learningspace.LearningSpaceRepository;
...
public class AggregateCourseTest {
  ...
  @Test
  @WithMockUser(username = AggregateCourseTest.AUTHOR, roles = {"professor"})
  public void createCourseExpectCreatedWithPost() throws Exception {
    LearningSpace learningSpace = this.createLearningSpace();
    Course course = new Course(AggregateCourseTest.SHORT_TITLE, AggregateCourseTest.TITLE,
        AggregateCourseTest.DESCRIPTION,
    ...
    assertThat(savedCourse.getTitle()).isEqualTo(AggregateCourseTest.TITLE);
    assertThat(savedCourse.getDescription()).isEqualTo(AggregateCourseTest.DESCRIPTION);
  ...
  public void createCourseExpectCreateWithPut() throws Exception {
    ...
    Course course = new Course(AggregateCourseTest.SHORT_TITLE, AggregateCourseTest.TITLE,
        AggregateCourseTest.DESCRIPTION,
        new ArrayList<>(Arrays.asList(learningSpace)));
    course.setAuthor(AggregateCourseTest.AUTHOR);
    String courseAsJsonString = this.objectMapper.writeValueAsString(course);
    JSONObject courseJsonObject = new JSONObject(courseAsJsonString);
    JSONArray jsonArray = new JSONArray(Arrays.asList("learningSpaces/" + learningSpace.getId()));
    courseJsonObject.put("learningSpaces", jsonArray);
  ...
  @Test
  @WithMockUser(username = AggregateCourseTest.AUTHOR, roles = {"student"})
  ...
  private LearningSpace createLearningSpace() {
    final LearningSpace learningSpace = new LearningSpace("LearningSpaceTest",
        AggregateCourseTest.createExamForm());
